...
namespace PaymentContext.Tests
{
    ...
    public class StudentTests
    {
        ...
        [TestMethod]
        public void DeveRetornarErroQuandoAtivaSubscription()
        {
        ...
        public void DeveRetornarErroQuandoSubscriptionNaoTemPayment()
        {
            _student.AddSubscription(_subscription);
            Assert.IsTrue(_student.Invalid);
        }
        ...
        [TestMethod]
        public void DeveRetornarSucessoQuandoAdicionaSubscription()
        {
